...
// SectorFundamentals is an alias for SectorAverages.
type SectorFundamentals = SectorAverages

// SectorStock represents a stock within a sector with key metrics.
