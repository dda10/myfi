...
type RecommendationRecord struct {
	...
	Return1Day  *float64 `json:"return1Day,omitempty"`
...
// AssetRecommendation represents an AI-generated recommendation input for logging.
...
type RecommendationAccuracy struct {
	...
	HighConfWinRate float64              `json:"highConfWinRate"`
	MedConfWinRate  float64              `json:"medConfWinRate"`
	LowConfWinRate  float64              `json:"lowConfWinRate"`
}
